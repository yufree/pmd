...
plot(net,vertex.label=NA,vertex.size = df$ms1/25,edge.width = df$diff2/20+0.00001)
# Check the degree of the nodes
# Show the degree distribution of the vertices
deg <- degree(net, mode="all")
degree_distribution(net)
plot(net, vertex.size=deg/2,vertex.label=NA,vertex.size = df$ms1/25,edge.width = df$diff2/20+0.00001)
