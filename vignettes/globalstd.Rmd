...
plotpca(std$data[std$stdmassindex,],lv = as.numeric(as.factor(std$group)),main = paste(sum(std$stdmassindex),"independent peaks"))
plotpca(std$data[stdcluster$stdmassindex2,],lv = as.numeric(as.factor(std$group)),main = paste(sum(stdcluster$stdmassindex2),"independent base peaks"))
plotpca(std$data[stdcluster2$stdmassindex2,],lv = as.numeric(as.factor(std$group)),main = paste(sum(stdcluster2$stdmassindex2),"independent reduced base peaks"))
...
pmds <- as.numeric(names(table(cdf$diff2)[order(table(cdf$diff2))]))
freq <- as.numeric(table(cdf$diff2)[order(table(cdf$diff2))])
